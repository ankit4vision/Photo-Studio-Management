...
<head>
    <meta charset="utf-8">
    <title>{{ strtoupper($transaction->transaction_type) }} RECEIPT #{{ $transaction->transaction_number ?? $transaction->id }}</title>
    <style>
        body {
...
<body>
    ...
    <!-- Second Section: Receipt Details (left) and Transaction Info (right) -->
    <table class="header-table">
        <tr>
            <td class="company-cell">
                <div class="company-name" style="font-size: 16px; text-transform: uppercase; letter-spacing: 1px;">{{ strtoupper($transactionType) }} RECEIPT</div>
            ...
            <td class="info-cell">
                <div class="company-name">Transaction Details</div>
                <div class="company-meta">Type: {{ $transactionType }}</div>
                <div class="company-meta">Category: {{ $categoryName }}</div>
                <div class="company-meta">Created By: {{ $createdByName }}</div>
                <div class="company-meta">Created On: {{ $transactionCreatedOn }}</div>
            </td>
        </tr>
    </table>
    ...
    <table class="products-table">
        <thead>
            <tr>
                <th class="text-start">Transaction Details</th>
            ...
            <tr>
                <td class="text-start">
                    ...
                    @if($transactionDescription)
                        <div style="margin-top: 4px;"><strong>Description:</strong> {{ $transactionDescription }}</div>
                    @endif
                    <div style="margin-top: 4px;"><strong>Created By:</strong> {{ $createdByName }}</div>
                </td>
    ...
    <table class="bottom-table">
        <tr>
            <td style="width:100%;vertical-align:top;">
                <div class="section-title" style="text-align:right;">TRANSACTION SUMMARY</div>
                <table class="summary-table">
                    ...
                    <tr class="final">
                        ...
                        <td class="value">₹{{ number_format($transactionAmount, 2) }}</td>
                    </tr>
                </table>
            </td>
        </tr>
