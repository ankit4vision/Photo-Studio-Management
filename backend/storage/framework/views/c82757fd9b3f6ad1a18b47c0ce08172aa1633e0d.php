...
<body>
    ...
    <div class="top-bar">
        <table>
            <tr>
                <td class="left" style="width: 60%;"><?php echo e($businessName); ?></td>
                <td class="logo-right" style="width: 40%; text-align: right;">
                    <?php if($logoBase64): ?>
                        <img src="<?php echo e($logoBase64); ?>" alt="<?php echo e($businessName); ?>" class="logo-img" />
                    <?php endif; ?>
                </td>
            </tr>
        </table>
        ...
        <tr>
            <td class="company-cell">
                ...
                <div class="company-meta" style="margin-top: 4px;">
                    ...
                    <div><strong>Invoice Generated:</strong> <?php echo e($invoiceGeneratedDate); ?>, <?php echo e($invoiceGeneratedTime); ?></div>
                    <div><strong>Order Date:</strong> <?php echo e($orderDate); ?></div>
                </div>
            </td>
            <td class="info-cell">
