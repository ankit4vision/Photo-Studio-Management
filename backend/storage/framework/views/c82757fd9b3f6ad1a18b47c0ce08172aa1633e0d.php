...
<body>
    ...
    <div class="top-bar">
        ...
        <div class="right">
            ...
            <div class="meta-row"><strong>Date:</strong> <?php echo e($invoiceDate); ?></div>
            <div class="meta-row"><strong>Time:</strong> <?php echo e($invoiceTime); ?></div>
        </div>
    </div>
        ...
        <tbody>
            ...
            <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <tr>
                    ...
                    <td class="text-end"><?php echo e($lineDiscount > 0 ? '₹' . number_format($lineDiscount, 2) : '-'); ?></td>
