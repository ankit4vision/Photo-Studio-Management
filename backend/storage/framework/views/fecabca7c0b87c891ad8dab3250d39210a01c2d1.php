...
<body>
    ...
    <div class="content">
        ...
        <?php if(isset($timestamp)): ?>
            <p><strong>Sent at:</strong> <?php echo e($timestamp); ?></p>
        <?php endif; ?>
...
<?php /**PATH D:\Codexaa\Projects\1-ravi-patel\Photo-Studio-Management\backend\resources\views/emails/test.blade.php ENDPATH**/ ?>